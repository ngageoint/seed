...
and a packaging version, tracking changes between the algorithm and the packaging of it. The following image naming
template maps to members defined under the `Job` object:
