...
expected to be gathered from a results manifest that by JobPack standard convention MUST be provided either on container
...
[source,javascript]
.JobPack Manifest - OutputData object
----
"outputData": {
  "files": [ // <1>
    {
